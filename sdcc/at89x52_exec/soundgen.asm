...
;------------------------------------------------------------
;	main.c:258: void timer2_isr() __interrupt 5 {
;	-----------------------------------------
;	 function timer2_isr
;	-----------------------------------------
_timer2_isr:
...
;	main.c:260: ms_cnt++;
	...
	addc	a,(_ms_cnt + 1)
	mov	(_ms_cnt + 1),a
;	main.c:261: if (ms_cnt == duration_ms_isr) {
...
;	-----------------------------------------
_main:
;	main.c:343: TMOD = 0x01;
	mov	_TMOD,#0x01
;	main.c:344: TL2 = T2L_RST;
	mov	_TL2,#0x0b
;	main.c:345: TH2 = T2H_RST;
	mov	_TH2,#0xfe
;	main.c:346: ET0 = 0;
	clr	_ET0
;	main.c:347: ET2 = 1;
	setb	_ET2
;	main.c:348: T2CON |= (1 << 2);  // T2R = 1
	orl	_T2CON,#0x04
;	main.c:349: EA = 1;
	setb	_EA
;	main.c:352: P34 = 1;
